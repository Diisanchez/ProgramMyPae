...
<div>
    ...
    <div class="form-control" name="description" id="" cols="30" rows="10">{{ old('description', $remittance) }}</div>
    {{-- @error('description')
        <div class="text-small text-danger">{{ $message }}</div>
    @enderror --}}
</div>
...
<!--  -->
<div>
    <label class="form-label" for="weight">Fecha:</label>
    <input class="form-control" type="date" name="date" id="date" value="{{ old('date', $remittance) }}"
        placeholder="Fecha">
    @error('date')
        <div class="text-small text-danger">{{ $message }}</div>
    @enderror
...
<div>
    <label class="form-label" for="weight">Hora:</label>
    <input class="form-control" type="time" name="time" id="time" value="{{ old('time', $remittance) }}"
        placeholder="Hora">
    @error('time')
        <div class="text-small text-danger">{{ $message }}</div>
    @enderror
...
<div>
    ...
    <input class="form-control" type="text" name="responsible" id="responsible" placeholder="Responsable"
        value="{{ old('responsible', $remittance) }}">
    @error('responsible')
        <div class="text-small text-danger">{{ $message }}</div>
    @enderror
</div>
...
{{-- <div>
    ...
    <input class="form-control" type="number" name="numberStudent" id="numberStudent"
        value="{{ old('numberStudent', $remittance) }}" placeholder="Estudiante">
    @error('numberStudent')
        <div class="text-small text-danger">{{ $message }}</div>
    @enderror
</div> --}}

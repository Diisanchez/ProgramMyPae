    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('index') }}" class="brand-link brand-logo">
                <img src="{{ asset('img/pae.png') }}" alt="My Pae" class="img-logo">
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('remittance.index') }}" class="nav-link active">
        ...
        <footer class="main-footer">
            <strong>Diego Chiriboga & Karen Mindero &copy; 2023-2024 <a href="https://www.mypae.com.co">My
                    Pae</a>.</strong>
